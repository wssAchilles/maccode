...
class AppConstants {
  ...
  static const String heavyApiBaseUrl =
      'https://sentinel-backend-cloudrun-nj4m3gcxqq-uc.a.run.app';

  static const String apiVersion = 'v1';

  // 超时配置
  static const Duration apiTimeout = Duration(seconds: 30);
  static const Duration dashboardTimeout = Duration(seconds: 90);
  static const Duration jobPollingTimeout = Duration(seconds: 90);
  ...
  // 优化服务配置
  static const Duration optimizationTimeout = Duration(
    seconds: 60,
  ); // 优化计算可能需要更长时间
