...
\subsection{家庭储能系统的智能管理需求}

分时电价（Time-of-Use, TOU）政策下，峰谷电价差可达2-4倍，为家庭储能系统的"低储高放"套利创造了经济空间。然而，传统电池管理系统（BMS）主要关注单体监测和安全保护，缺乏系统层面的智能优化能力。当前主要痛点包括：
...
本项目为家庭储能用户提供低门槛的智能管理工具，验证了数据科学方法在能源管理领域的应用价值。
...
本项目以家庭储能系统为典型场景。考虑一户配置 Tesla Powerwall 储能电池（容量 13.5 kWh、最大功率 5 kW、效率 95\%）的家庭，接入分时电价计费方案。参考加州 PG\&E 费率\cite{pge2024tou}，本项目采用简化的三段式电价模型：
