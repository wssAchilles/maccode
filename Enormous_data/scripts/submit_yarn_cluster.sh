...
CONFIG_PATH="${1:-configs/yarn-cluster.yaml}"
RUN_ID="${2:-}"
...
spark-class org.apache.hadoop.fs.FsShell -mkdir -p /spark-history /user/course/ecommerce_behavior_processed_cluster || true
