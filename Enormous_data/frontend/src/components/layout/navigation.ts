...
export const navItems: NavItem[] = [
  ...
  { to: '/query', label: '智能查询', detail: '中文问题、受控意图和图表结果', group: '智能分析', icon: Sparkles },
  ...
  { to: '/lifecycle', label: '用户分层', detail: '生命周期、最近活跃频次价值、风险队列和偏好类目', group: '智能分析', icon: UsersRound },
  { to: '/cohorts', label: '留存复购', detail: '留存分群、复购间隔、价值曲线和类目风险', group: '智能分析', icon: Repeat2 },
  { to: '/experiments', label: '策略实验', detail: '对照分流、增量提升先验、实验护栏和执行清单', group: '智能分析', icon: FlaskConical },
  { to: '/forecasting', label: '需求预测', detail: '成交额预测、稀疏回退、回测和营收风险', group: '智能分析', icon: TrendingUpDown },
  { to: '/live-training', label: '实时训练', detail: '天气外部信号、微批回测和实时影响评分', group: '智能分析', icon: CloudSun },
  ...
  { to: '/ops', label: '作业状态', detail: 'Spark 运行、血缘和清单', group: '数据与运维', icon: Database },
];
